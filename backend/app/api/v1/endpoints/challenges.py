...
async def get_challenges(
    ...
    # Convert to response format with user participation info
    challenge_list = []
    ...
    total = len(challenges)  # This is simplified; in production, you'd count separately
...
async def get_my_created_challenges(
    ...
    for challenge in challenges:
        ...
        challenge_dict = {
            ...
            "updated_at": challenge.updated_at,
            "friends_joined": active_participants,
            "is_joined": False,  # Creator doesn't need to "join" their own challenge
            "creator_username": current_user.username
        }
        challenge_list.append(Challenge(**challenge_dict))
