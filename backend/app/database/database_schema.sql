...
CREATE TABLE public.gym_buddies (
  ...
  CONSTRAINT gym_buddies_pkey PRIMARY KEY (user_id, buddy_id),
...
CREATE TABLE public.reported_posts (
  ...
  CONSTRAINT reported_posts_pkey PRIMARY KEY (reported_post_id, reportedby_userid),
...
CREATE TABLE public.ride_activity_participants (
  ...
  user_id uuid NOT NULL,
  joined_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT ride_activity_participants_pkey PRIMARY KEY (ride_activity_id, user_id),
