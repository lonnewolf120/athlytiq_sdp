...
-- Chat and Friends Tables (Phase 1 Addition)
...
-- Table: friends (accepted relationships)
...
-- Table: chat_message_reads (for group chats)
...
-- Indexes for Chat and Friends Performance
