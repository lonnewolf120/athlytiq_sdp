...
// // Add a minimal request model to fix the missing type
...
//       isMuted: isMuted ?? state.rooms[roomIndex].isMuted,
//       isPinned: isPinned ?? state.rooms[roomIndex].isPinned,
//     );
...
//     // Call API
//     _chatService.updateRoomSettings(
//       roomId,
//       isMuted: isMuted,
//       isPinned: isPinned,
//     );
...
//     try {
//       final request = await _friendsService.sendFriendRequest(
//         userId,
//         message: message,
//       );

//       state = state.copyWith(sentRequests: [request, ...state.sentRequests]);
//     } catch (e) {
//       state = state.copyWith(error: e.toString());
//     }
//   }
...
//           state.friends.where((f) => f.userId != friendId).toList();
...
//     String query, {
//     bool excludeFriends = true,
//   }) async {
//     try {
//       return await _friendsService.searchUsers(
//         query,
...
//           state = state.copyWith(friends: [friend, ...state.friends]);
//         }
//         break;
