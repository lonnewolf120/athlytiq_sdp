...
class GeminiWorkoutNotifier extends StateNotifier<List<Workout>> {
  ...
  Future<void> _loadWorkoutPlans() async {
    ...
    try {
      ...
      debugPrint('GeminiWorkoutNotifier: No internet connection while loading workout plans: ${e.message}');
  ...
  Future<void> generateWorkoutPlan(Map<String, dynamic> userInfo) async {
    ...
    try {
      ...
      final Workout newWorkout = await _geminiService.generateWorkoutPlan(userInfo);
      debugPrint(
      ...
      debugPrint('GeminiWorkoutNotifier: No internet connection while generating workout plan: ${e.message}');
      rethrow; // Re-throw to be caught by UI if needed
...
final geminiWorkoutPlanProvider = StateNotifierProvider<GeminiWorkoutNotifier, List<Workout>>((ref) {
