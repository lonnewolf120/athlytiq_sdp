...
class _BookingScreenState extends State<BookingScreen> {
  ...
  final List<String> _durations = ['30 Minutes', '1 Hour', '2 Hours', 'Custom'];
              ...
              showDialog(
                ...
                builder:
                    (context) => AlertDialog(
                      ...
                      content: const Text(
                        'Contact the trainer for a free consultation before booking?',
                      ),
                      actions: [
                        TextButton(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    color: app_colors.AppColors.darkInputBorder,
                  ),
                ),
              ),
            ),
                          ...
                          showDialog(
                            ...
                            builder:
                                (context) => AlertDialog(
                                  ...
                                  content: Text(
                                    'You have booked a session for \\$_selectedGoal (\\${_selectedDuration!}) using \\$_selectedPayment.',
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () => Navigator.pop(context),
