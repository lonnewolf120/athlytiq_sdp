                ...
                children: [
                  ...
                  Consumer<ChatProvider>(
                    builder: (context, chatProvider, child) {
                      final typingIndicators = chatProvider
                          .getTypingIndicatorsForRoom(widget.room.id);
                      if (typingIndicators.isNotEmpty) {
                        return Text(
                          '${typingIndicators.first.username} is typing...',
                          style: AppTextStyles.darkBodySmall.copyWith(
                            color: AppColors.darkSecondaryText.withOpacity(0.9),
                          ),
                        );
                      }
            ...
            content: Column(
              ...
              children: [
                ...
                if (widget.room.lastMessageAt != null)
                  Text(
                    'Last message: ${_formatDate(widget.room.lastMessageAt!)}',
                  ),
              ],
            ),
            actions: [
